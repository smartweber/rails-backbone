...
# Instead of pushing jobs to Redis, Sidekiq pushes them into a jobs array which you can access.
...
VCR.configure do |config|
  ...
  config.default_cassette_options = { match_requests_on: [:method, :host, :path], allow_playback_repeats: true }
end
